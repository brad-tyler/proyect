        ...
        <div>
            <div class="p-4 grid grid-cols-12 gap-6">
                ...
                <a class="transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                    ...
                    <div class="p-5">
                        <div class="flex justify-between">
                            <svg aria-hidden="true" class="h-7 w-7 text-blue-400" fill="currentColor"
                ...
                <a class="transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                    ...
                    <div class="p-5">
                        <div class="flex justify-between">
                            <svg aria-hidden="true" class="h-7 w-7 text-yellow-400" fill="currentColor"
                ...
                <a class="transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                    ...
                    <div class="p-5">
                        <div class="flex justify-between">
                            <svg aria-hidden="true" class="h-7 w-7 text-pink-600" fill="currentColor"
                ...
                <a class="transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                    ...
                    <div class="p-5">
                        <div class="flex justify-between">
                            <svg aria-hidden="true" class="h-7 w-7 text-green-400" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
            ...
            <div class="bg-white min-h-screen overflow-hidden shadow-xl sm:rounded-lg p-4 flex flex-col gap-7">
                <!-- <Welcome /> -->
                ...
                <div class="py-4">
                    <div class="flex gap-10 w-full">
                        <a class="flex-1 transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                            href="#">
                            <div class="mt-3 text-xl text-center font-bold leading-8">
                                Barra Estadistica
                            </div>
                            <div class="p-20">
                                <Chart type="bar" :data="chartData" :options="chartOptions" class="flex-1" />
                            </div>
                        </a>
                        <a class="flex-1 transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                            href="#">
